...
class PoolsControllerTest < ActionController::TestCase
  ...
  test "should create pool" do
    assert_difference('Pool.count') do
      post :create, pool: { create_time: @pool.create_time, game_id: @pool.game_id, match_id: @pool.match_id, match_result: @pool.match_result, sell_statu: @pool.sell_statu }
    end
  ...
  test "should update pool" do
    patch :update, id: @pool, pool: { create_time: @pool.create_time, game_id: @pool.game_id, match_id: @pool.match_id, match_result: @pool.match_result, sell_statu: @pool.sell_statu }
    assert_redirected_to pool_path(assigns(:pool))
  end
